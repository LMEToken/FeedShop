...
class CustomLayout: UICollectionViewLayout {
    ...
    override func layoutAttributesForItemAtIndexPath(indexPath: NSIndexPath)
        -> UICollectionViewLayoutAttributes? {
            ...
            //单元格边长
            let largeCellSide:CGFloat = 230
            let smallCellSide:CGFloat = 115
            
            //内部间隙，左右5
            let insets = UIEdgeInsetsMake(5, 7, 5, 5)
...
//            
            ...
            if (indexPath.item % 6 == 0) {
                ...
                attribute.frame = CGRectMake(smallCellSide+insets.left*2, lineOriginY, smallCellSide,
                                             smallCellSide)
            } else if (indexPath.item % 6 == 2) {
                attribute.frame = CGRectMake(smallCellSide*2+insets.left*3,
                                             lineOriginY, smallCellSide, smallCellSide)
            }
